...
namespace WebServer
{
    ...
    public class UserRequestController : AbstractEntityRequestController
    {
        ...
        /// <summary>
        /// This method returns a delegate that can be used to get a User in a given storage.
        /// The delegate only contain the id value. id is the only thing needed to get a User.
        /// @pre request != null
        /// @pre request.Method != null
        /// </summary>
        /// <param name="request">The original request recieved by the webserver</param>
        /// <returns>  A delegate that can be used to get a user from a given storage, based on the contents of the request </returns>
